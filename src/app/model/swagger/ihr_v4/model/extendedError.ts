 ...
 */
import { ExtendedErrorInvalidParamsInner } from './extendedErrorInvalidParamsInner';


/**
 * Object gespecificeerd volgens https://tools.ietf.org/html/rfc7807.
 */
export interface ExtendedError { 
    ...
    detail: string;
    instance?: string;
    invalidParams: Array<ExtendedErrorInvalidParamsInner>;
}
