 ...
 */
import { BestemmingsvlakReferentie } from './bestemmingsvlakReferentie';
import { StructuurvisieverklaringReferentie } from './structuurvisieverklaringReferentie';
import { StructuurvisiecomplexReferentie } from './structuurvisiecomplexReferentie';
import { ArtikelLinksSelf } from './artikelLinksSelf';
import { BesluitsubvlakReferentie } from './besluitsubvlakReferentie';
import { FunctieaanduidingReferentie } from './functieaanduidingReferentie';
import { BesluitvlakReferentie } from './besluitvlakReferentie';
import { StructuurvisiegebiedReferentie } from './structuurvisiegebiedReferentie';
import { MaatvoeringReferentie } from './maatvoeringReferentie';
import { TekstReferentie } from './tekstReferentie';
import { BouwaanduidingReferentie } from './bouwaanduidingReferentie';
import { FiguurReferentie } from './figuurReferentie';
import { GebiedsaanduidingReferentie } from './gebiedsaanduidingReferentie';


export interface TekstLinks { 
    self: ArtikelLinksSelf;
    children: Array<TekstReferentie>;
    bestemmingsvlakken: Array<BestemmingsvlakReferentie>;
    bouwaanduidingen: Array<BouwaanduidingReferentie>;
    figuren: Array<FiguurReferentie>;
    functieaanduidingen: Array<FunctieaanduidingReferentie>;
    gebiedsaanduidingen: Array<GebiedsaanduidingReferentie>;
    lettertekenaanduidingen: Array<string>;
    maatvoeringen: Array<MaatvoeringReferentie>;
    besluitvlakken: Array<BesluitvlakReferentie>;
    besluitsubvlakken: Array<BesluitsubvlakReferentie>;
    structuurvisiegebieden: Array<StructuurvisiegebiedReferentie>;
    structuurvisiecomplexen: Array<StructuurvisiecomplexReferentie>;
    structuurvisieverklaringen: Array<StructuurvisieverklaringReferentie>;
}
