 ...
 */
import { BaseStructuurvisiegebiedBeleidInner } from './baseStructuurvisiegebiedBeleidInner';
import { FunctieaanduidingAllOfEmbedded } from './functieaanduidingAllOfEmbedded';
import { StructuurvisiegebiedLinks } from './structuurvisiegebiedLinks';
...
export interface Structuurvisiegebied { 
    id: string;
    naam: string;
    thema: Array<string>;
    beleid: Array<BaseStructuurvisiegebiedBeleidInner>;
    ...
    _links: StructuurvisiegebiedLinks;
    geometrie?: Array<GeoJSONGeometry>;
    _embedded?: FunctieaanduidingAllOfEmbedded;
}
