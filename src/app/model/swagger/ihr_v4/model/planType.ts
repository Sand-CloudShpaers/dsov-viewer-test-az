...
/**
 * De types `buiten toepassing verklaring beheersverordening` en `rijksbestemmingsplan` zouden in de praktijk niet voor mogen komen, dit is een datakwaliteit issue.
 */
export type PlanType = 'uitwerkingsplan' | 'wijzigingsplan' | 'inpassingsplan' | 'beheersverordening' | 'bestemmingsplan' | 'exploitatieplan' | 'tijdelijke ontheffing buitenplans' | 'omgevingsvergunning' | 'projectbesluit' | 'reactieve aanwijzing' | 'gerechtelijke uitspraak' | 'voorbereidingsbesluit' | 'provinciale verordening' | 'aanwijzingsbesluit' | 'amvb' | 'regeling' | 'structuurvisie' | 'rijksbestemmingsplan' | 'buiten toepassing verklaring beheersverordening' | 'gemeentelijke visie; overig';

export const PlanType = {
    Uitwerkingsplan: 'uitwerkingsplan' as PlanType,
    Wijzigingsplan: 'wijzigingsplan' as PlanType,
    Inpassingsplan: 'inpassingsplan' as PlanType,
    Beheersverordening: 'beheersverordening' as PlanType,
    Bestemmingsplan: 'bestemmingsplan' as PlanType,
    Exploitatieplan: 'exploitatieplan' as PlanType,
    TijdelijkeOntheffingBuitenplans: 'tijdelijke ontheffing buitenplans' as PlanType,
    Omgevingsvergunning: 'omgevingsvergunning' as PlanType,
    Projectbesluit: 'projectbesluit' as PlanType,
    ReactieveAanwijzing: 'reactieve aanwijzing' as PlanType,
    GerechtelijkeUitspraak: 'gerechtelijke uitspraak' as PlanType,
    Voorbereidingsbesluit: 'voorbereidingsbesluit' as PlanType,
    ProvincialeVerordening: 'provinciale verordening' as PlanType,
    Aanwijzingsbesluit: 'aanwijzingsbesluit' as PlanType,
    Amvb: 'amvb' as PlanType,
    Regeling: 'regeling' as PlanType,
    Structuurvisie: 'structuurvisie' as PlanType,
    Rijksbestemmingsplan: 'rijksbestemmingsplan' as PlanType,
    BuitenToepassingVerklaringBeheersverordening: 'buiten toepassing verklaring beheersverordening' as PlanType,
    GemeentelijkeVisieOverig: 'gemeentelijke visie; overig' as PlanType
};
