...
export interface PlanBeleidsmatigVerantwoordelijkeOverheid { 
    type: PlanBeleidsmatigVerantwoordelijkeOverheid.TypeEnum;
    /**
     * CBS-code van de beleidsmatig verantwoordelijke overheid. Altijd 4 cijfers, indien nodig aangevuld met voorloopnullen.
     */
    code: string | null;
    naam: string | null;
}
export namespace PlanBeleidsmatigVerantwoordelijkeOverheid {
    export type TypeEnum = 'gemeentelijke overheid' | 'deelgemeente/stadsdeel' | 'provinciale overheid' | 'nationale overheid';
    export const TypeEnum = {
        GemeentelijkeOverheid: 'gemeentelijke overheid' as TypeEnum,
        DeelgemeenteStadsdeel: 'deelgemeente/stadsdeel' as TypeEnum,
        ProvincialeOverheid: 'provinciale overheid' as TypeEnum,
        NationaleOverheid: 'nationale overheid' as TypeEnum
    };
}
