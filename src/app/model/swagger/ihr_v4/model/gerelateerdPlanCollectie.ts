 ...
 */
import { GerelateerdPlan } from './gerelateerdPlan';


export interface GerelateerdPlanCollectie { 
    gerelateerdePlannen: Array<GerelateerdPlan>;
    gerelateerdVanuit: Array<GerelateerdPlan>;
}
