 ...
 */
import { CartografieSummaryCollectieEmbedded } from './cartografieSummaryCollectieEmbedded';
import { CollectieLinks } from './collectieLinks';


export interface CartografieSummaryCollectie { 
    _embedded: CartografieSummaryCollectieEmbedded;
