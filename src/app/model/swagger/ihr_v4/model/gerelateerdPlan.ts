...
import { GerelateerdPlanLinks } from './gerelateerdPlanLinks';
import { PlanType } from './planType';
import { GerelateerdPlanBeleidsmatigVerantwoordelijkeOverheid } from './gerelateerdPlanBeleidsmatigVerantwoordelijkeOverheid';
 ...
 * Gerelateerd plan
 */
export interface GerelateerdPlan { 
    id: string;
    type: PlanType;
    beleidsmatigVerantwoordelijkeOverheid: GerelateerdPlanBeleidsmatigVerantwoordelijkeOverheid;
    publicerendBevoegdGezag: GerelateerdPlanBeleidsmatigVerantwoordelijkeOverheid;
    naam: string;
    ...
    relatietype: GerelateerdPlan.RelatietypeEnum;
    _links: GerelateerdPlanLinks;
}
export namespace GerelateerdPlan {
    export type RelatietypeEnum = 'vervangt' | 'muteert' | 'tenGevolgeVan' | 'gebruiktInformatieUit' | 'gedeeltelijkeHerzieningVan' | 'uitTeWerkenIn' | 'uitgewerktIn';
    export const RelatietypeEnum = {
        Vervangt: 'vervangt' as RelatietypeEnum,
        Muteert: 'muteert' as RelatietypeEnum,
        TenGevolgeVan: 'tenGevolgeVan' as RelatietypeEnum,
        GebruiktInformatieUit: 'gebruiktInformatieUit' as RelatietypeEnum,
        GedeeltelijkeHerzieningVan: 'gedeeltelijkeHerzieningVan' as RelatietypeEnum,
        UitTeWerkenIn: 'uitTeWerkenIn' as RelatietypeEnum,
        UitgewerktIn: 'uitgewerktIn' as RelatietypeEnum
    };
}
