 ...
 */
import { BaseBestemmingsvlakBestemmingsfunctiesInner } from './baseBestemmingsvlakBestemmingsfunctiesInner';
import { BestemmingsvlakAllOfEmbedded } from './bestemmingsvlakAllOfEmbedded';
import { BestemmingsvlakLinks } from './bestemmingsvlakLinks';
import { GeoJSONGeometry } from './geoJSONGeometry';


export interface Bestemmingsvlak { 
    id: string;
    type: Bestemmingsvlak.TypeEnum;
    naam: string;
    /**
     * Beschikbaar in IMRO2008 en IMRO2012
     */
    bestemmingshoofdgroep: string | null;
    /**
     * Beschikbaar in IMRO2006
     */
    bestemmingsfuncties: Array<BaseBestemmingsvlakBestemmingsfunctiesInner>;
    artikelnummer: string | null;
    verwijzingNaarTekst: Array<string>;
    labelInfo: string | null;
    _links: BestemmingsvlakLinks;
    geometrie?: GeoJSONGeometry;
    _embedded?: BestemmingsvlakAllOfEmbedded;
}
export namespace Bestemmingsvlak {
    export type TypeEnum = 'enkelbestemming' | 'dubbelbestemming';
    export const TypeEnum = {
        Enkelbestemming: 'enkelbestemming' as TypeEnum,
        Dubbelbestemming: 'dubbelbestemming' as TypeEnum
    };
}
