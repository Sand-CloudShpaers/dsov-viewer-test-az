 ...
 */
import { BaseMaatvoeringOmvangInner } from './baseMaatvoeringOmvangInner';
import { FunctieaanduidingAllOfEmbedded } from './functieaanduidingAllOfEmbedded';
import { MaatvoeringLinks } from './maatvoeringLinks';
...
export interface Maatvoering { 
    id: string;
    naam: string;
    omvang: Array<BaseMaatvoeringOmvangInner>;
    verwijzingNaarTekst: string | null;
    _links: MaatvoeringLinks;
