 ...
 */
import { FunctieaanduidingCollectieEmbedded } from './functieaanduidingCollectieEmbedded';
import { CollectieLinks } from './collectieLinks';


export interface FunctieaanduidingCollectie { 
    _embedded: FunctieaanduidingCollectieEmbedded;
