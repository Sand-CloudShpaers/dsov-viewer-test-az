 ...
 */
import { ExterneReferentie } from './externeReferentie';
import { Kruimel } from './kruimel';
import { TekstWithAggregationsAllOfEmbedded } from './tekstWithAggregationsAllOfEmbedded';
import { TekstLinks } from './tekstLinks';


export interface TekstWithAggregations { 
    id: string;
    titel: string | null;
    /**
     * Inhoud van van het tekstblok. Voor de Ruimtelijke Plannen is dit XHTML, voor LVBB wellicht XML en voor andere informatiehuizen wellicht plain text. Hoe een client dit moet behandelen wordt in de verbeelding afgehandeld.
     */
    inhoud: string | null;
    volgnummer: number;
    externeReferentie: ExterneReferentie | null;
    kruimelpad: Array<Kruimel>;
    _links: TekstLinks;
    _embedded?: TekstWithAggregationsAllOfEmbedded;
}
