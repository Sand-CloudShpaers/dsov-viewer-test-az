 ...
 */
import { BesluitsubvlakCollectieEmbedded } from './besluitsubvlakCollectieEmbedded';
import { CollectieLinks } from './collectieLinks';


export interface BesluitsubvlakCollectie { 
    _embedded: BesluitsubvlakCollectieEmbedded;
