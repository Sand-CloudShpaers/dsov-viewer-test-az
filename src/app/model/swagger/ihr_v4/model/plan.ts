...
import { PlanstatusInfo } from './planstatusInfo';
import { IllustratieReferentie } from './illustratieReferentie';
import { PlanHeeftOnderdelenInner } from './planHeeftOnderdelenInner';
import { PlanRelatiesMetExternePlannen } from './planRelatiesMetExternePlannen';
import { PlanType } from './planType';
import { GeoJSONGeometry } from './geoJSONGeometry';
import { PlanPublicerendBevoegdGezag } from './planPublicerendBevoegdGezag';
import { PlanDossier } from './planDossier';
import { PlanOndergrondenInner } from './planOndergrondenInner';
import { PlanBeleidsmatigVerantwoordelijkeOverheid } from './planBeleidsmatigVerantwoordelijkeOverheid';


export interface Plan { 
    id: string;
    type: PlanType;
    beleidsmatigVerantwoordelijkeOverheid: PlanBeleidsmatigVerantwoordelijkeOverheid;
    publicerendBevoegdGezag: PlanPublicerendBevoegdGezag | null;
    naam: string;
    locatienamen: Array<string>;
    planstatusInfo: PlanstatusInfo;
    verwijzingNaarVaststellingsbesluit: string | null;
    verwijzingNaarGml: string;
    besluitnummer: string | null;
    verwijzingNorm: Array<string>;
    normadressant: Array<string>;
    ondergronden: Array<PlanOndergrondenInner>;
    relatiesMetExternePlannen: PlanRelatiesMetExternePlannen;
    relatiesVanuitExternePlannen: PlanRelatiesMetExternePlannen;
    illustraties: Array<IllustratieReferentie>;
    heeftOnderdelen: Array<PlanHeeftOnderdelenInner>;
    regelStatus: string | null;
    regelBinding: string | null;
    dossier: PlanDossier | null;
    isHistorisch: boolean;
    verwijderdOp: string | null;
    isTamPlan: boolean;
    eindeRechtsgeldigheid: string | null;
    geometrie?: GeoJSONGeometry;
    bbox?: GeoJSONGeometry;
    isParapluplan: boolean;
    beroepEnBezwaar: Plan.BeroepEnBezwaarEnum | null;
    _links: PlanLinks;
}
export namespace Plan {
    export type BeroepEnBezwaarEnum = 'Ja' | 'Nee' | 'Niet van toepassing';
    export const BeroepEnBezwaarEnum = {
        Ja: 'Ja' as BeroepEnBezwaarEnum,
        Nee: 'Nee' as BeroepEnBezwaarEnum,
        NietVanToepassing: 'Niet van toepassing' as BeroepEnBezwaarEnum
    };
}
