 ...
 */
import { LettertekenaanduidingLinksSelf } from './lettertekenaanduidingLinksSelf';


export interface LettertekenaanduidingLinks { 
    self: LettertekenaanduidingLinksSelf;
}
