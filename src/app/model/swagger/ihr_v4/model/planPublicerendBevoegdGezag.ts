...
export interface PlanPublicerendBevoegdGezag { 
    type: PlanPublicerendBevoegdGezag.TypeEnum;
    /**
     * CBS-code van het actuele bevoegd gezag overheid. Altijd 4 cijfers, indien nodig aangevuld met voorloopnullen.
     */
    code: string | null;
    naam: string | null;
}
export namespace PlanPublicerendBevoegdGezag {
