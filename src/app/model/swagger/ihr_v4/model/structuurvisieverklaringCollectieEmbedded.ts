 ...
 */
import { Structuurvisieverklaring } from './structuurvisieverklaring';


export interface StructuurvisieverklaringCollectieEmbedded { 
    structuurvisieverklaringen: Array<Structuurvisieverklaring>;
}
