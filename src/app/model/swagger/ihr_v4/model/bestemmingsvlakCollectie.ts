 ...
 */
import { BestemmingsvlakCollectieEmbedded } from './bestemmingsvlakCollectieEmbedded';
import { CollectieLinks } from './collectieLinks';


export interface BestemmingsvlakCollectie { 
    _embedded: BestemmingsvlakCollectieEmbedded;
