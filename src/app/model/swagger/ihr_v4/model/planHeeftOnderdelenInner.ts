 ...
 */
import { PlanHeeftOnderdelenInnerHeeftObjectgerichteTekstenInner } from './planHeeftOnderdelenInnerHeeftObjectgerichteTekstenInner';


export interface PlanHeeftOnderdelenInner { 
    externeReferenties: Array<string>;
    type: string;
    heeftObjectgerichteTeksten: Array<PlanHeeftOnderdelenInnerHeeftObjectgerichteTekstenInner>;
}
