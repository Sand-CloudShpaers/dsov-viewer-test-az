 ...
 */
import { StructuurvisieverklaringLinksSelf } from './structuurvisieverklaringLinksSelf';
import { TekstReferentie } from './tekstReferentie';


export interface StructuurvisieverklaringLinks { 
    self: StructuurvisieverklaringLinksSelf;
