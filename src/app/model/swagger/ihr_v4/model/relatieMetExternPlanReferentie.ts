 ...
 */
import { RelatieMetExternPlanReferentieDossier } from './relatieMetExternPlanReferentieDossier';
import { RelatieMetExternPlanReferentiePlanstatusInfo } from './relatieMetExternPlanReferentiePlanstatusInfo';


/**
 * Relatie met extern plan.
 */
export interface RelatieMetExternPlanReferentie { 
    naam: string | null;
    id: string | null;
    planstatusInfo: RelatieMetExternPlanReferentiePlanstatusInfo | null;
    dossier: RelatieMetExternPlanReferentieDossier | null;
    href: string | null;
}
