 ...
 */
import { GebiedsaanduidingCollectieEmbedded } from './gebiedsaanduidingCollectieEmbedded';
import { CollectieLinks } from './collectieLinks';


export interface GebiedsaanduidingCollectie { 
    _embedded: GebiedsaanduidingCollectieEmbedded;
