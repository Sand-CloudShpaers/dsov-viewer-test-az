 ...
 */
import { Structuurvisiecomplex } from './structuurvisiecomplex';


export interface StructuurvisiecomplexCollectieEmbedded { 
    structuurvisiecomplexen: Array<Structuurvisiecomplex>;
}
