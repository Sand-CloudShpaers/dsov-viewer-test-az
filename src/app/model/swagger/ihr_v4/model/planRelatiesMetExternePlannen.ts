 ...
 */
import { RelatieMetExternPlanReferentie } from './relatieMetExternPlanReferentie';


export interface PlanRelatiesMetExternePlannen { 
    vervangt: Array<RelatieMetExternPlanReferentie>;
    tenGevolgeVan: Array<RelatieMetExternPlanReferentie>;
    muteert: Array<RelatieMetExternPlanReferentie>;
    gebruiktInformatieUit: Array<RelatieMetExternPlanReferentie>;
    gedeeltelijkeHerzieningVan: Array<RelatieMetExternPlanReferentie>;
    uitTeWerkenIn: Array<RelatieMetExternPlanReferentie>;
    uitgewerktIn: Array<RelatieMetExternPlanReferentie>;
}
