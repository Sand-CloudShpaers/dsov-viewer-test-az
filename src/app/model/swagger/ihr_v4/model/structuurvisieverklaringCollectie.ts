 ...
 */
import { StructuurvisieverklaringCollectieEmbedded } from './structuurvisieverklaringCollectieEmbedded';
import { CollectieLinks } from './collectieLinks';


export interface StructuurvisieverklaringCollectie { 
    _embedded: StructuurvisieverklaringCollectieEmbedded;
    _links: CollectieLinks;
}
