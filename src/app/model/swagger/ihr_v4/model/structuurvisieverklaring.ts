...
import { StructuurvisieverklaringAllOfEmbedded } from './structuurvisieverklaringAllOfEmbedded';
import { IllustratieReferentie } from './illustratieReferentie';
import { GeoJSONGeometry } from './geoJSONGeometry';
import { StructuurvisieverklaringLinks } from './structuurvisieverklaringLinks';


export interface Structuurvisieverklaring { 
    id: string;
    naam: string;
    thema: Array<string>;
    ...
    _links: StructuurvisieverklaringLinks;
    geometrie?: Array<GeoJSONGeometry>;
    _embedded?: StructuurvisieverklaringAllOfEmbedded;
}
