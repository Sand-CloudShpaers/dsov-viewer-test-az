 ...
 */
import { PlanSuggestieCollectieEmbedded } from './planSuggestieCollectieEmbedded';


export interface PlanSuggestieCollectie { 
    _embedded: PlanSuggestieCollectieEmbedded;
}
