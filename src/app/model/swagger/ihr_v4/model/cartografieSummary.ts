...
import { CartografieSummaryLinks } from './cartografieSummaryLinks';


export interface CartografieSummary {
    thema?: Array<string>;
    cartografieInfo?: Array<CartografieInfo>;
    verwijzingNaarTekst?: Array<string>;
    objectNaam?: string;
    objectId?: string;
    objectType?: CartografieSummary.ObjectTypeEnum;
    _links?: CartografieSummaryLinks;
}

export namespace CartografieSummary {
    export type ObjectTypeEnum = 'structuurvisiegebied' | 'structuurvisiecomplex' | 'structuurvisieverklaring' | 'besluitvlak' | 'besluitsubvlak';
    export const ObjectTypeEnum = {
        Structuurvisiegebied: 'structuurvisiegebied' as ObjectTypeEnum,
        Structuurvisiecomplex: 'structuurvisiecomplex' as ObjectTypeEnum,
        Structuurvisieverklaring: 'structuurvisieverklaring' as ObjectTypeEnum,
        Besluitvlak: 'besluitvlak' as ObjectTypeEnum,
        Besluitsubvlak: 'besluitsubvlak' as ObjectTypeEnum
    };
}
