 ...
 */
import { Structuurvisiegebied } from './structuurvisiegebied';


export interface StructuurvisiegebiedCollectieEmbedded { 
    structuurvisiegebieden: Array<Structuurvisiegebied>;
}
