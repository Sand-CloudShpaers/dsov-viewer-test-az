 ...
 */
import { BaseStructuurvisiegebiedRelatiesMetExternePlannen } from './baseStructuurvisiegebiedRelatiesMetExternePlannen';
import { CartografieInfo } from './cartografieInfo';
import { BaseStructuurvisiecomplexBeleidInner } from './baseStructuurvisiecomplexBeleidInner';
import { IllustratieReferentie } from './illustratieReferentie';
import { StructuurvisiecomplexLinks } from './structuurvisiecomplexLinks';
import { GeoJSONGeometry } from './geoJSONGeometry';
import { StructuurvisiecomplexAllOfEmbedded } from './structuurvisiecomplexAllOfEmbedded';


export interface Structuurvisiecomplex { 
    id: string;
    naam: string;
    thema: Array<string>;
    beleid: Array<BaseStructuurvisiecomplexBeleidInner>;
    verwijzingNaarTekst: Array<string>;
    illustraties: Array<IllustratieReferentie>;
    relatiesMetExternePlannen: BaseStructuurvisiegebiedRelatiesMetExternePlannen;
    cartografieInfo: Array<CartografieInfo>;
    _links: StructuurvisiecomplexLinks;
    geometrie?: Array<GeoJSONGeometry>;
    _embedded?: StructuurvisiecomplexAllOfEmbedded;
}
