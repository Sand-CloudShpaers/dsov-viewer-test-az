...
import { BouwaanduidingCollectieEmbedded } from './bouwaanduidingCollectieEmbedded';


export interface BouwaanduidingCollectie { 
    _embedded: BouwaanduidingCollectieEmbedded;
