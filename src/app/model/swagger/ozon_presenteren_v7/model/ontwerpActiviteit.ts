 ...
 */
import { OntwerpActiviteitLinks } from './ontwerpActiviteitLinks';
import { OntwerpRegistratiegegevens } from './ontwerpRegistratiegegevens';
import { Activiteitengroep } from './activiteitengroep';
 ...
 */
export interface OntwerpActiviteit { 
    ...
    /**
     * Deze status parameter is deprecated, U wordt verwezen naar het status veld in de registratiegegevens.
     */
    status?: string;
    _links: OntwerpActiviteitLinks;
}
