...
import { RegeltekstLinks } from './regeltekstLinks';
...
export interface Regeltekst { 
    ...
    typeJuridischeRegels?: Regeltekst.TypeJuridischeRegelsEnum;
    instructieregelInstrument?: Array<Instrument>;
    instructieregelTaakuitoefening?: Array<Adressaat>;
    _embedded?: Embedded;
    _links: RegeltekstLinks;
}
export namespace Regeltekst {
    export type TypeJuridischeRegelsEnum = 'regel voor iedereen' | 'instructieregel' | 'omgevingswaarderegel';
    export const TypeJuridischeRegelsEnum = {
        RegelVoorIedereen: 'regel voor iedereen' as TypeJuridischeRegelsEnum,
        Instructieregel: 'instructieregel' as TypeJuridischeRegelsEnum,
        Omgevingswaarderegel: 'omgevingswaarderegel' as TypeJuridischeRegelsEnum
    };
}
