 ...
 */
import { OntwerpGebiedsaanwijzingLinks } from './ontwerpGebiedsaanwijzingLinks';
import { Embedded1 } from './embedded1';
import { OntwerpRegistratiegegevens } from './ontwerpRegistratiegegevens';
import { Gebiedsaanwijzinggroep } from './gebiedsaanwijzinggroep';


/**
 * Type gebied aangewezen door een juridische regel.
 */
export interface OntwerpGebiedsaanwijzing { 
    ...
    /**
     * Een (korte) naam van de gebiedsaanwijzing. 
     */
    naam?: string;
    label?: string;
    /**
     ...
     */
    status?: string;
    groep?: Gebiedsaanwijzinggroep;
    _embedded?: Embedded1;
    geregistreerdMet: OntwerpRegistratiegegevens;
    _links: OntwerpGebiedsaanwijzingLinks;
}
