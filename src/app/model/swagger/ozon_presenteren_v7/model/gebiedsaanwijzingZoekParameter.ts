 ...
 */
export interface GebiedsaanwijzingZoekParameter { 
    parameter?: GebiedsaanwijzingZoekParameter.ParameterEnum;
    /**
     * Waarden waarop gezocht moet worden voor de betreffende parameter
     */
    zoekWaarden?: Array<string>;
}
export namespace GebiedsaanwijzingZoekParameter {
    export type ParameterEnum = 'identificatie' | 'regeltekst.type' | 'locatie.identificatie' | 'subType' | 'juridischeregel.thema' | 'tekstdeel.thema' | 'document.identificatie' | 'document.type' | 'document.bestuurslaag' | 'ontwerpdocument.technischId';
    export const ParameterEnum = {
        ...
        SubType: 'subType' as ParameterEnum,
        JuridischeregelThema: 'juridischeregel.thema' as ParameterEnum,
        TekstdeelThema: 'tekstdeel.thema' as ParameterEnum,
