...
/**
 * Een op zichzelf staande geometrisch afgebakende lijnlocatie in de fysieke leefomgeving. De geometrische afbakening is juridisch van aard, oftewel is niet fysiek van aard en bevindt zich niet in de fysieke werkelijkheid. Anders gezegd, de afbakening is virtueel.
 */
export interface Lijn { 
    ...
    _links?: SelfLinks;
    /**
     * De geometrische bepaling van de lijn door middel van coördinaten.
     */
    geometrie?: Array<string>;
    /**
