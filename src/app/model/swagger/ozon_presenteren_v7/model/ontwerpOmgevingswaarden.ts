...
import { OntwerpOmgevingswaardenEmbedded } from './ontwerpOmgevingswaardenEmbedded';
import { Page } from './page';


export interface OntwerpOmgevingswaarden { 
    _embedded: OntwerpOmgevingswaardenEmbedded;
