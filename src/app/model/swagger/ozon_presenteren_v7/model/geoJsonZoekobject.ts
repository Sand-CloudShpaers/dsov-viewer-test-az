...
/**
 * Zoekobject om te zoeken op geometrie.
 */
export interface GeoJsonZoekobject { 
    geometrie: GeoJsonGeometry;
    /**
     * De intersects operator zoals gedefinieerd in ISO 19125-1
     */
    spatialOperator: GeoJsonZoekobject.SpatialOperatorEnum;
}
export namespace GeoJsonZoekobject {
    export type SpatialOperatorEnum = 'intersects';
    export const SpatialOperatorEnum = {
        Intersects: 'intersects' as SpatialOperatorEnum
    };
}
