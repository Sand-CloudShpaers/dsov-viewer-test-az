 ...
 */
import { HalPaginationLinksAllOfNext } from './halPaginationLinksAllOfNext';
import { HalPaginationLinksAllOfFirst } from './halPaginationLinksAllOfFirst';
import { HalPaginationLinksAllOfLast } from './halPaginationLinksAllOfLast';
import { HalCollectionLinksSelf } from './halCollectionLinksSelf';
import { HalPaginationLinksAllOfPrev } from './halPaginationLinksAllOfPrev';


export interface HalPaginationLinks { 
    self?: HalCollectionLinksSelf;
    first?: HalPaginationLinksAllOfFirst;
    last?: HalPaginationLinksAllOfLast;
    prev?: HalPaginationLinksAllOfPrev;
    next?: HalPaginationLinksAllOfNext;
}
