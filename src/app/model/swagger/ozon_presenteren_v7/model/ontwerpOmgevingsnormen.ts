...
import { OntwerpOmgevingsnormenEmbedded } from './ontwerpOmgevingsnormenEmbedded';
import { Page } from './page';


export interface OntwerpOmgevingsnormen { 
    _embedded: OntwerpOmgevingsnormenEmbedded;
