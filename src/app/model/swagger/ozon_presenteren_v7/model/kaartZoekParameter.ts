 ...
 */
export interface KaartZoekParameter { 
    parameter?: KaartZoekParameter.ParameterEnum;
    /**
     * Waarden waarop gezocht moet worden voor de betreffende parameter
     */
    zoekWaarden?: Array<string>;
}
export namespace KaartZoekParameter {
    export type ParameterEnum = 'naam' | 'nummer' | 'documentIdentificatie';
    export const ParameterEnum = {
        Naam: 'naam' as ParameterEnum,
        Nummer: 'nummer' as ParameterEnum,
