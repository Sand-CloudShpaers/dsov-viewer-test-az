 ...
 */
export interface OntwerpActiviteitZoekParameter { 
    parameter?: OntwerpActiviteitZoekParameter.ParameterEnum;
    /**
     * Waarden waarop gezocht moet worden voor de betreffende parameter
     */
    zoekWaarden?: Array<string>;
}
export namespace OntwerpActiviteitZoekParameter {
    export type ParameterEnum = 'technischId' | 'ontwerpregeltekst.type' | 'ontwerplocatie.technischId' | 'ontwerpdocument.technischId' | 'ontwerpdocument.type' | 'ontwerpdocument.bestuurslaag';
