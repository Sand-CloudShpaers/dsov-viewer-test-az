...
import { OntwerpDivisieannotatiesEmbedded } from './ontwerpDivisieannotatiesEmbedded';
import { Page } from './page';


export interface OntwerpDivisieannotaties { 
    _embedded: OntwerpDivisieannotatiesEmbedded;
