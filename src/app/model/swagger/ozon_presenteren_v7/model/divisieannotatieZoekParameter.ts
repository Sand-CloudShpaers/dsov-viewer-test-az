 ...
 */
export interface DivisieannotatieZoekParameter { 
    parameter?: DivisieannotatieZoekParameter.ParameterEnum;
    /**
     * Waarden waarop gezocht moet worden voor de betreffende parameter
     */
    zoekWaarden?: Array<string>;
}
export namespace DivisieannotatieZoekParameter {
    export type ParameterEnum = 'gebiedsaanwijzing.identificatie' | 'thema.code' | 'hoofdlijn.identificatie' | 'locatie.identificatie' | 'documentIdentificatie';
