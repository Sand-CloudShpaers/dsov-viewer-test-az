...
import { OntwerpDocumentComponentenEmbedded } from './ontwerpDocumentComponentenEmbedded';
import { Page } from './page';


export interface OntwerpDocumentComponenten { 
    _embedded: OntwerpDocumentComponentenEmbedded;
