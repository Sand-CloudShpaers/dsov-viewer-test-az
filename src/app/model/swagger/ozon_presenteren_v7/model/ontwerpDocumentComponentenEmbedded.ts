 ...
 */
import { OntwerpDocumentComponent } from './ontwerpDocumentComponent';


export interface OntwerpDocumentComponentenEmbedded { 
    ontwerpDocumentComponenten: Array<OntwerpDocumentComponent>;
}
