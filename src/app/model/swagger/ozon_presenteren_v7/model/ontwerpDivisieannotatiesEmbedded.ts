 ...
 */
import { OntwerpDivisieannotatie } from './ontwerpDivisieannotatie';


export interface OntwerpDivisieannotatiesEmbedded { 
    ontwerpdivisieannotaties: Array<OntwerpDivisieannotatie>;
}
