...
export interface OntwerpActiviteitLinks { 
    self: HalLink;
    beschrevenIn?: HalLink;
    isGereguleerdVoor?: HalLink;
    is?: HalLink;
    gerelateerd?: HalLink;
    isGereguleerdVoorVastgesteld?: HalLink;
    isVastgesteld?: HalLink;
    gerelateerdVastgesteld?: HalLink;
}
