...
import { OntwerpGebiedsaanwijzingenEmbedded } from './ontwerpGebiedsaanwijzingenEmbedded';


export interface OntwerpGebiedsaanwijzingen { 
    _embedded: OntwerpGebiedsaanwijzingenEmbedded;
