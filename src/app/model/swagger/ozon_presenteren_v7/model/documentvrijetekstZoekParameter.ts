 ...
 */
export interface DocumentvrijetekstZoekParameter { 
    parameter?: DocumentvrijetekstZoekParameter.ParameterEnum;
    /**
     * Waarden waarop gezocht moet worden voor de betreffende parameter
     */
    zoekWaarden?: Array<string>;
}
export namespace DocumentvrijetekstZoekParameter {
    export type ParameterEnum = 'gebiedsaanwijzing.identificatie' | 'locatie.identificatie' | 'hoofdlijn.identificatie' | 'thema.code' | 'document.type' | 'document.typeBevoegdGezag' | 'document.bevoegdGezag';
