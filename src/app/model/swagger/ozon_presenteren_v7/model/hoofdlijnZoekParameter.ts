 ...
 */
export interface HoofdlijnZoekParameter { 
    parameter?: HoofdlijnZoekParameter.ParameterEnum;
    /**
     * Waarden waarop gezocht moet worden voor de betreffende parameter
     */
    zoekWaarden?: Array<string>;
}
export namespace HoofdlijnZoekParameter {
    export type ParameterEnum = 'documentIdentificatie' | 'ontwerpdocument.technischId';
