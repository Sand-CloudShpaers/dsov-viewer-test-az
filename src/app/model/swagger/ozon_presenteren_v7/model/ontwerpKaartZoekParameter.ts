 ...
 */
export interface OntwerpKaartZoekParameter { 
    parameter?: OntwerpKaartZoekParameter.ParameterEnum;
    /**
     * Waarden waarop gezocht moet worden voor de betreffende parameter
     */
    zoekWaarden?: Array<string>;
}
export namespace OntwerpKaartZoekParameter {
    export type ParameterEnum = 'naam' | 'nummer' | 'ontwerpdocument.technischId';
