...
/**
 * Zoekobject om Omgevingswaarden te zoeken met een parameter.
 */
export interface OmgevingswaardeZoekParameter { 
    parameter?: OmgevingswaardeZoekParameter.ParameterEnum;
    /**
     * Waarden waarop gezocht moet worden voor de betreffende parameter
     */
    zoekWaarden?: Array<string>;
}
export namespace OmgevingswaardeZoekParameter {
    export type ParameterEnum = 'identificatie' | 'regeltekst.type' | 'locatie.identificatie' | 'juridischeregel.thema' | 'tekstdeel.thema' | 'document.identificatie' | 'document.type' | 'document.bestuurslaag' | 'ontwerpdocument.technischId';
