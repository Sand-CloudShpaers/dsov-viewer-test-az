...
export type TypeJuridischeRegels = 'regel voor iedereen' | 'instructieregel' | 'omgevingswaarderegel';

export const TypeJuridischeRegels = {
    RegelVoorIedereen: 'regel voor iedereen' as TypeJuridischeRegels,
    Instructieregel: 'instructieregel' as TypeJuridischeRegels,
    Omgevingswaarderegel: 'omgevingswaarderegel' as TypeJuridischeRegels
};
