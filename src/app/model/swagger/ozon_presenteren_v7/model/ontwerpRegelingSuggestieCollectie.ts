 ...
 */
import { OntwerpRegelingSuggestieCollectieEmbedded } from './ontwerpRegelingSuggestieCollectieEmbedded';


export interface OntwerpRegelingSuggestieCollectie { 
    _embedded: OntwerpRegelingSuggestieCollectieEmbedded;
}
