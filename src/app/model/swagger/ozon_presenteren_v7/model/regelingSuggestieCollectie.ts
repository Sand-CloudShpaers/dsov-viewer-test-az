 ...
 */
import { RegelingSuggestieCollectieEmbedded } from './regelingSuggestieCollectieEmbedded';


export interface RegelingSuggestieCollectie { 
    _embedded: RegelingSuggestieCollectieEmbedded;
}
