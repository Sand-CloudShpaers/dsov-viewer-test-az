...
/**
 * Een lijst met een opsomming van de mogelijke domeinwaarden van een attribuutsoort, die buiten het model in een externe waardenlijst worden beheerd.  Locatie: urn:imow:Activiteitregel
 */
export interface Activiteitregelkwalificatie { 
    code: string;
    waarde: string;
}
