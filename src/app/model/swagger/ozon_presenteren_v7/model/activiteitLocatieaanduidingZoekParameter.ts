 ...
 */
export interface ActiviteitLocatieaanduidingZoekParameter { 
    parameter?: ActiviteitLocatieaanduidingZoekParameter.ParameterEnum;
    /**
     * Waarden waarop gezocht moet worden voor de betreffende parameter
     */
    zoekWaarden?: Array<string>;
}
export namespace ActiviteitLocatieaanduidingZoekParameter {
    export type ParameterEnum = 'activiteit.identificatie' | 'regeltekst.identificatie' | 'locatie.identificatie' | 'juridischeregel.thema' | 'document.identificatie' | 'document.type' | 'document.bestuurslaag' | 'ontwerpdocument.technischId';
    export const ParameterEnum = {
        ActiviteitIdentificatie: 'activiteit.identificatie' as ParameterEnum,
        RegeltekstIdentificatie: 'regeltekst.identificatie' as ParameterEnum,
