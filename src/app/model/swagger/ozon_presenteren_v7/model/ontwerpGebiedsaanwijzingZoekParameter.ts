 ...
 */
export interface OntwerpGebiedsaanwijzingZoekParameter { 
    parameter?: OntwerpGebiedsaanwijzingZoekParameter.ParameterEnum;
    /**
     * Waarden waarop gezocht moet worden voor de betreffende parameter
     */
    zoekWaarden?: Array<string>;
}
export namespace OntwerpGebiedsaanwijzingZoekParameter {
    export type ParameterEnum = 'technischId' | 'ontwerpregeltekst.type' | 'locatie.identificatie' | 'ontwerpLocatie.technischId' | 'ontwerpdocument.technischId' | 'ontwerpdocument.type' | 'ontwerpdocument.bestuurslaag';
