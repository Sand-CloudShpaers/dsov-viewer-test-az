 ...
 */
import { ActiviteitLocatieaanduidingLinks } from './activiteitLocatieaanduidingLinks';
import { Activiteit } from './activiteit';
import { Activiteitregelkwalificatie } from './activiteitregelkwalificatie';
import { Embedded } from './embedded';


export interface ActiviteitLocatieaanduiding { 
    identificatie: string;
    activiteitregelkwalificatie: Activiteitregelkwalificatie;
    betreftEenActiviteit: Activiteit;
    _embedded?: Embedded;
    _links: ActiviteitLocatieaanduidingLinks;
}
