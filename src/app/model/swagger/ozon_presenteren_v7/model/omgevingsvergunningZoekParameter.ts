...
/**
 * Zoekobject om Omgevingsvergunning te zoeken met een parameter.
 */
export interface OmgevingsvergunningZoekParameter { 
    parameter?: OmgevingsvergunningZoekParameter.ParameterEnum;
    /**
     * Waarden waarop gezocht moet worden voor de betreffende parameter
     */
    zoekWaarden?: Array<string>;
}
export namespace OmgevingsvergunningZoekParameter {
    export type ParameterEnum = 'vergunning.typeBevoegdGezag' | 'vergunning.bevoegdGezag' | 'locatie.identificatie';
    export const ParameterEnum = {
        VergunningTypeBevoegdGezag: 'vergunning.typeBevoegdGezag' as ParameterEnum,
        VergunningBevoegdGezag: 'vergunning.bevoegdGezag' as ParameterEnum,
