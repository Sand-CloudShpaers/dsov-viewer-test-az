 ...
 */
export interface OntwerpHoofdlijnZoekParameter { 
    parameter?: OntwerpHoofdlijnZoekParameter.ParameterEnum;
    /**
     * Waarden waarop gezocht moet worden voor de betreffende parameter
     */
    zoekWaarden?: Array<string>;
}
export namespace OntwerpHoofdlijnZoekParameter {
    export type ParameterEnum = 'ontwerpdocument.technischId';
