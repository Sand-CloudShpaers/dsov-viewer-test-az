 ...
 */
import { OmgevingsvergunningSuggestieCollectieEmbedded } from './omgevingsvergunningSuggestieCollectieEmbedded';


export interface OmgevingsvergunningSuggestieCollectie { 
    _embedded: OmgevingsvergunningSuggestieCollectieEmbedded;
}
