...
export type LocatieType = 'Gebied' | 'Lijn' | 'Punt' | 'Gebiedengroep' | 'Lijnengroep' | 'Puntengroep' | 'Ambtsgebied';

export const LocatieType = {
    Gebied: 'Gebied' as LocatieType,
    Lijn: 'Lijn' as LocatieType,
    Punt: 'Punt' as LocatieType,
    Gebiedengroep: 'Gebiedengroep' as LocatieType,
    Lijnengroep: 'Lijnengroep' as LocatieType,
    Puntengroep: 'Puntengroep' as LocatieType,
    Ambtsgebied: 'Ambtsgebied' as LocatieType
};
