 ...
 */
import { OntwerpRegelingSuggestie } from './ontwerpRegelingSuggestie';


export interface OntwerpRegelingSuggestieCollectieEmbedded { 
    suggesties?: Array<OntwerpRegelingSuggestie>;
}
